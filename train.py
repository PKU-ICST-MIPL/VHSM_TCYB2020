...
def train(sess, saver, train_graph, valid_graph, trainDataStream, devDataStream, options, best_path, image):
    ...
    for epoch in range(options.max_epochs):
        ...
        ##train_accuracy
        #train_acc = total_correct/float(total)*100
...
def main(FLAGS):
    ...
    sys.stdout.flush()
    devDataStream = SentenceMatchDataStream(test_path, word_vocab=word_vocab, char_vocab=char_vocab, label_vocab=label_vocab,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--test_path', type=str, default="./data/snli/test_new.tsv",help='Path to the test set.')
    ...
    parser.add_argument('--suffix', type=str, default='snli', help='Suffix of the model name.')
