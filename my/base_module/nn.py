...
from my.base_module import flatten, reconstruct, add_wd, exp_mask
...
def fuse_gate(is_train, lhs, rhs, scope=None):
    with tf.variable_scope(scope or "fuse_gate"):
        ...
        # else:
        lhs_1 = linear(lhs, dim ,True, bias_start=0.0, scope="lhs_1", squeeze=False, wd=0.0, input_keep_prob=1.0, is_train=is_train)
        rhs_1 = linear(rhs, dim ,True, bias_start=0.0, scope="rhs_1", squeeze=False, wd=0.0, input_keep_prob=1.0, is_train=is_train)
        """
        ...
        # else:
        lhs_2 = linear(lhs, dim ,True, bias_start=0.0, scope="lhs_2", squeeze=False, wd=0.0, input_keep_prob=1.0, is_train=is_train)
        rhs_2 = linear(rhs, dim ,True, bias_start=0.0, scope="rhs_2", squeeze=False, wd=0.0, input_keep_prob=1.0, is_train=is_train)
